...
import Pic from "../../assets/images/members/yubin2.png";
import {useEffect} from 'react'


export default function Yubin() {
    useEffect(()=> {
        window.scrollTo(0,0)
    })
			...
			<div className="bg-darkest relative text-darkest ">
				...
				<div className="h-[300px]">
					<div className=" bread_wrap ">
						...
						<img src={Rarrow} alt="" className="w-[9px]" />
						<Link to="/members/yubin">Bin Yu</Link>
					</div>
				</div>
				{/* 头像加简介部分 */}
				<div className="banner_frame_style">
					...
					<div className="banner_text">
						<h1>
							于滨 <span className="w-px inline-block"></span> Bin Yu
						</h1>

						<h2>飞利浦数据设计师 / Data Designer in Philips Design</h2>
						<h2>
							助理教授 / Assistant Professor at Nyenrode Business University
						</h2>
						<h2>数据驱动设计 | 飞利浦设计 | 人机交互研究</h2>
					</div>
