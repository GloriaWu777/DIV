...
import Pic from "../../assets/images/members/lizhuying2.png";
import { useEffect } from 'react';

export default function Lizhuyin() {
	useEffect(()=>{
		window.scrollTo(0,0)
	},[])
  return (
			...
			<div className="bg-darkest relative text-darkest ">
				...
				<div className="h-[300px]">
					<div className=" bread_wrap ">
						...
						<img src={Rarrow} alt="" className="w-[9px]" />
						<Link to="/members/lizhuying">Zhuying Li</Link>
					</div>
				</div>
				{/* 头像加简介部分 */}
				<div className="banner_frame_style">
					...
					<div className="banner_text">
						<h1>
							李竹颖 <span className="w-px inline-block"></span> Zhuying Li
						</h1>
